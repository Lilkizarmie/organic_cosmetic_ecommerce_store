...
class Signup(View):
    ...
    def validateCustomer(self, customer):
        ...
        if(not customer.first_name):
            ...
            error_message = 'Phone Number must be 10 Integers long or more'
        elif len(customer.phone) > 10:
            error_message = 'Phone Number must be 10 Integers long or less'
        elif not customer.email:
            error_message = 'Enter your Email'
        elif len(customer.email) < 5:
            error_message = 'Email must be 5 characters long or more'
