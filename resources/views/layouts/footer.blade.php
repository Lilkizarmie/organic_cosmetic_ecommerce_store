<footer class="pt-10 pt-lg-14 pb-8 footer bg-gray">
  <div class="container container-xl">
    <div class="row">
      ...
      <div class="col-lg-5 col-12 mb-9 mb-lg-0">
        <h3 class="mb-2 custom-font-02 font-weight-400">Good emails.</h3>
        <p class="lh-2">Enter your email below to be the first to know about new collections and product
          launches.</p>
        <form class="pt-4">
          <div class="input-group position-relative">
            <input type="email" class="form-control bg-white rounded-left" placeholder="Enter your email address">
