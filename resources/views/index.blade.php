  ...
  <main id="content">
      ...
      <div class="row no-gutters">
        <div class="col-6">
          <div class="card border-0 banner banner-10 hover-zoom-in hover-shine">
            <div class="card-img bg-img-cover-center" style="background-image: url('images/banner-51.jpg');"></div>
            <div
        ...
        <div class="col-6">
          <div class="card border-0 banner banner-10 hover-zoom-in hover-shine">
            <div class="card-img bg-img-cover-center" style="background-image: url('images/banner-50.jpg');"></div>
            <div
              class="card-img-overlay d-inline-flex flex-column p-6 p-md-9 align-items-center justify-content-center bg-overlay-gradient-02">
              <p class="card-text fs-16 fs-sm-18 fs-md-24 text-white mb-2" data-animate="fadeInUp">
                Find Inspration
    ...
    <section class="pt-lg-13 pt-11 pb-9 pb-lg-11">
      <div class="container container-xl">
        ...
        <p class="fs-18 mb-8" style="max-width:490px" data-animate="fadeInUp">Looking for something specific? Shop by
      ...
      <div class="container container-lg-full">
        <div class="slick-slider custom-slider-03"
            ...
            <div class="card border-0 product" data-animate="fadeInUp">
              ...
              <div class="card-body pt-4 text-center">
                ...
                <h2 class="card-title fs-15 font-weight-500 mb-2"><a href="product-detail.html"
                    class="hover-accent">Facial cleanser</a></h2>
          ...
          <div class="box">
            <div class="card border-0 product" data-animate="fadeInUp">
              <div class="position-relative">
                <img src="images/product-05.jpg" alt="Bio-shroom Rejuvenating Serum">
                <div class="card-img-overlay d-flex p-3">
                  <div>
                  </div>
                  <div class="my-auto w-100 content-change-vertical">
              ...
              <div class="card-body pt-4 text-center">
                ...
                <h2 class="card-title fs-15 font-weight-500 mb-2"><a href="product-detail.html"
                    class="hover-accent">Bio-shroom Rejuvenating Serum</a></h2>
                <div class="d-flex align-items-center justify-content-center flex-wrap">
                  <ul class="list-inline mb-0 lh-1">
                    <li class="list-inline-item fs-12 text-accent mr-0"><i class="fas fa-star"></i>
                    </li>
          ...
          <div class="box">
            <div class="card border-0 product" data-animate="fadeInUp">
              ...
              <div class="card-body pt-4 text-center">
                ...
                <h2 class="card-title fs-15 font-weight-500 mb-2"><a href="product-detail.html"
                    class="hover-accent">Coffee Bean Caffeine Eye Cream</a></h2>
                <div class="d-flex align-items-center justify-content-center flex-wrap">
                  <ul class="list-inline mb-0 lh-1">
                    <li class="list-inline-item fs-12 text-accent mr-0"><i class="fas fa-star"></i>
                    </li>
          ...
          <div class="box">
            <div class="card border-0 product" data-animate="fadeInUp">
              <div class="position-relative">
                <img src="images/product-02.jpg" alt="Facial cleanser">
                <div class="card-img-overlay d-flex p-3">
                  <div>
                  </div>
                  <div class="my-auto w-100 content-change-vertical">
        ...
        <div class="row">
          <div class="col-12 col-md-7 col-lg-8 mb-6 mb-lg-0" data-animate="fadeInUp">
            <div class="card border-0 banner banner-01 hover-zoom-in hover-shine">
              <div class="card-img bg-img-cover-center" style="background-image: url('images/banner-40.jpg');"></div>
              <div class="card-img-overlay d-inline-flex flex-column p-6 p-md-8 justify-content-center">
                ...
                <h3 class="card-title fs-34 lh-129 text-white custom-font-02 font-weight-400" style="max-width: 270px">
          ...
          <div class="col-12 col-md-5 col-lg-4" data-animate="fadeInUp">
            <div class="card border-0 banner banner-01 hover-zoom-in hover-shine">
              <div class="card-img bg-img-cover-center" style="background-image: url('images/banner-41.jpg');"></div>
              <div class="card-img-overlay d-inline-flex flex-column p-6 p-md-8">
                <h3 class="card-title fs-34 lh-129 mb-2 custom-font-02 font-weight-400">25% off Everything</h3>
    ...
    <section class="pt-lg-13 pt-10">
      <div class="container container-xl">
            ...
            <ul class="nav nav-pills justify-content-center mb-lg-9 mb-7" role="tablist">
              <li class="nav-item px-md-6 px-0" data-animate="fadeInUp">
                <a class="pointer nav-link active text-secondary px-xl-3 py-1 lh-1 fs-lg-40 fs-md-34 fs-24 custom-font-02 font-weight-400 bg-transparent rounded-0 text-active-secondary hover-active-opacity-3"
                  ...
                  aria-controls="pills-best-sellers" aria-selected="true">Best Sellers</a>
              </li>
              <li class="nav-item px-md-6 px-0" data-animate="fadeInUp">
                <a class="pointer nav-link  text-secondary px-xl-3 py-1 lh-1 fs-lg-40 fs-md-34 fs-24 custom-font-02 font-weight-400 bg-transparent rounded-0 text-active-secondary hover-active-opacity-3"
                  ...
                  aria-controls="pills-new-arrivals" aria-selected="true">New Arrivals</a>
              </li>
              <li class="nav-item px-md-6 px-0" data-animate="fadeInUp">
                <a class="pointer nav-link  text-secondary px-xl-3 py-1 lh-1 fs-lg-40 fs-md-34 fs-24 custom-font-02 font-weight-400 bg-transparent rounded-0 text-active-secondary hover-active-opacity-3"
                  id="pills-sale-tab" data-toggle="pill" href="#pills-sale" role="tab" aria-controls="pills-sale"
        ...
        <div class="text-center">
          <a href="shop-page-04.html" class="btn btn-outline-secondary border-2x border" data-animate="fadeInUp">Shop
            All Products</a>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-4 mb-6 mb-md-0" data-animate="fadeInUp">
            <div class="card border-0 text-center">
              ...
              <div class="card-body px-0 pt-6 pb-0">
                <h3 class="fs-24 mb-2"><a href="shop.html" class="text-decoration-none">Find a Store</a></h3>
          ...
          <div class="col-md-4 mb-6 mb-md-0" data-animate="fadeInUp">
            <div class="card border-0 text-center">
              ...
              <div class="card-body px-0 pt-6 pb-0">
                <h3 class="fs-24 mb-2"><a href="blog-grid.html" class="text-decoration-none">From Our Blog</a></h3>
          ...
          <div class="col-md-4 mb-6 mb-md-0" data-animate="fadeInUp">
            <div class="card border-0 text-center">
              ...
              <div class="card-body px-0 pt-6 pb-0">
                <h3 class="fs-24 mb-2"><a href="about-us.html" class="text-decoration-none">Our Story</a></h3>
