        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <ul class="list-inline mb-0 widget-color">
              ...
              <li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #C69D97;"></a>
              </li>
              <li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #92967F;"></a>
              </li>
              <li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #D7A983;"></a>
              </li>
              <li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #4F6B66;"></a>
              </li>
              <li class="list-inline-item"><a href="#" class="d-block item border"
                  style="background-color: #FFFFFF;"></a>
              </li>
              <li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #AB5C4F;"></a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="container container-xl">
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 product mb-6" data-animate="fadeInUp">
              <div class="position-relative">
                <img src="images/product-06.jpg" alt="Facial cleanser">
                <div class="card-img-overlay d-flex p-3 flex-column">
                  <div>
                    <span class="badge badge-primary">-20%</span>
                  </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 product mb-6" data-animate="fadeInUp">
              <div class="position-relative">
                <img src="images/product-08.jpg" alt="Bio-shroom Rejuvenating Serum">
                <div class="card-img-overlay d-flex p-3 flex-column">
                  <div>
                  </div>
                  <div class="w-100 content-change-horizontal d-flex justify-content-center mt-auto">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 product mb-6" data-animate="fadeInUp">
              <div class="position-relative">
                <img src="images/product-10.jpg" alt="Facial cleanser">
                <div class="card-img-overlay d-flex p-3 flex-column">
                  <div>
                    <span class="badge badge-primary">-20%</span>
                  </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 product mb-6" data-animate="fadeInUp">
              <div class="position-relative">
                <img src="images/product-18.jpg" alt="Bio-shroom Rejuvenating Serum">
                <div class="card-img-overlay d-flex p-3 flex-column">
                  <div>
                  </div>
                  <div class="w-100 content-change-horizontal d-flex justify-content-center mt-auto">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 product mb-6" data-animate="fadeInUp">
              <div class="position-relative">
                <img src="images/product-14.jpg" alt="Coffee Bean Caffeine Eye Cream">
                <div class="card-img-overlay d-flex p-3 flex-column">
                  <div>
                    <span class="badge badge-primary">-20%</span>
                  </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 product mb-6" data-animate="fadeInUp">
              <div class="position-relative">
                <img src="images/product-12.jpg" alt="Facial cleanser">
                <div class="card-img-overlay d-flex p-3 flex-column">
                  <div>
                    <span class="badge badge-primary">-20%</span>
                  </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 product mb-6" data-animate="fadeInUp">
              <div class="position-relative">
                <img src="images/product-13.jpg" alt="Bio-shroom Rejuvenating Serum">
                <div class="card-img-overlay d-flex p-3 flex-column">
                  <div>
                  </div>
                  <div class="w-100 content-change-horizontal d-flex justify-content-center mt-auto">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 product mb-6" data-animate="fadeInUp">
              <div class="position-relative">
                <img src="images/product-07.jpg" alt="Coffee Bean Caffeine Eye Cream">
                <div class="card-img-overlay d-flex p-3 flex-column">
                  <div>
                  </div>
                  <div class="w-100 content-change-horizontal d-flex justify-content-center mt-auto">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card border-0 product mb-6" data-animate="fadeInUp">
              <div class="position-relative">
                <img src="images/product-19.jpg" alt="Coffee Bean Caffeine Eye Cream">
                <div class="card-img-overlay d-flex p-3 flex-column">
                  <div>
                    <span class="badge badge-primary">-20%</span>
                  </div>
